 ...
 *
 * This OpMode starts off at the Blue Corner station of the competition pit and continues on
 * to scan the jewel and the pictograph, knocking off the jewel with a servo arm in the process
 * (see jewelServoL for Blue op modes). Afterwards, the robot uses encoders to travel to the
...
@Autonomous(name="Blue Corner: Key Jewel", group ="Blue")
public class Auto_BCKeyJewel extends LinearOpMode {
    ...
    @Override public void runOpMode() {
        ...
        switch (jewelAtFront) {
            ...
            case BLUE: //Knock off the front jewel.
                ...
                slightTurn(1);
                break;
            default: //Assume that the 'unseen' jewel is red. Knock off the front jewel.
                slightTurn(1);
                jewelServoL.setPosition(LSERVO_UP_POSITION);
                sleep(250);
                slightTurn(-1);
    ...
    private void setupDefaultValues() {
        ...
        ticksToSecondColumn = 1925;
        ticksToThirdColumn = 2650;
